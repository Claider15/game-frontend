      ...
      <GardenBorder className="shadow p-3 grid gap-4 grid-cols-2">
        <ImgContainer className={imgContainer}>
            <div className="relative">
                <GardenImg src="/public/img/garden01.jpg" />  
                <Circulo className={circulo}/>
            </div>

            <div className="mt-4 relative">
                <EnterContainer src="/public/img/card_button.png" />
        ...
        <ImgContainer className={imgContainer}>
            <div className="relative">
                <GardenImg src="/public/img/garden02.jpg" />  
                <Circulo className={circulo}/>
            </div>
        ...
        <ImgContainer className={imgContainer}>
            <div className="relative">
                <GardenImg src="/public/img/garden04.jpg" />  
                <Circulo className={circulo}/>
            </div>
        ...
        <ImgContainer className={imgContainer}>
            <div className="relative">
                <GardenImg src="/public/img/garden05.jpg" />  
                <Circulo className={circulo}/>
            </div>
